...
class Instamojo {
    ...
    */
    ...
    {
        $arr = $this->api_call('GET', 'links/get_file_upload_url', array());
        return $arr['upload_url'];
    }
    ...
    */
    ...
    {
        $arr = $this->api_call('GET', 'links', array());
        return $arr['links'];
    }
    ...
    */  
    ...
    {
        $arr = $this->api_call('GET', 'links/' . $slug, array());
        return $arr['link'];
    }
    ...
    */  
    ...
    {   
        ...
        $arr = $this->api_call('POST', 'links', $link);
        return $arr['link'];
    }
    ...
    */  
    ...
    {
        $link = $this->uploadMagic($link);
        $arr = $this->api_call('PATCH', 'links/' . $slug, $link);
        return $arr['link'];
    }
    ...
    */  
    ...
    {
        $arr = $this->api_call('GET', 'payments', array());
        return $arr['payments'];
    }
    ...
    */  
    ...
    {
        $arr = $this->api_call('GET', 'payments/' . $payment_id, array());
        return $arr['payment'];
    }
}
?>
